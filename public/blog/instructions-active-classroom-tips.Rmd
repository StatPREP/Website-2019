...
2. Have an **assessment plan**.
    ...
    Some ideas for formative assessment: Minute papers, a simple show of hands,
    class room polling apps, etc.  If students are working in groups, be 
    prepared with some diagnostic questions you can ask to check on their 
...
6. **Borrow** and **share**.
    ...
    Watch for webinars related to statistics education. [CAUSE]() currates some of these.
