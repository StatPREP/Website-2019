...
2. **Digging deeper:** Want to dig deeper on an item? Add a follow-up question.
    ...
    * Choose one of the scenarios that could be designed as a randomized experiment. Explain how randomization would be used.
    
    *Come up with some additional follow-up questions of your own. Can you think of some that require multi-variable thinking?*
