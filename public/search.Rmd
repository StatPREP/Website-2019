...
- 2:00 pm: [Welcome](/presentations/welcome/) & housekeeping Announcements
- 2:15 pm: [Icebreaker](/images/Icebreaker.pdf): Teaching Statistics 
- 2:30 pm: [GAISE and ASA/AMATYC guidelines to teaching statistics](/presentations/GAISE-ASA/)
- 2:50 pm: [Tidy data](/presentations/tidy-data/) & [grammatical graphics](/presentations/grammatical-graphics/)
- 3:20 pm: Break
- 3:30 pm: Orientation to the StatPREP website and Little Apps: Kate Kozak
- 4:00 pm: Using StatPREP Little Apps in the Classroom Activity #1: [Center and spread](https://statprep-activities.netlify.com/topics/instructions-center-spread/) with Kate Kozak
- 4:50 pm: Break
- 5:00 pm: [Introduction to RStudio cloud](/etc/technology/)
...
- 8:00 am: Breakfast 
- 8:30 am: [Tutorials with  R](/etc/tutorials/)
- 9:00 am: Using StatPREP Little Apps in the Classroom Activity #2: [Normal distribution](https://statprep-activities.netlify.com/topics/instructions-normal-distribution/) with Kate Kozak
- 9:45 am: Searching for Data:  Finding [good sources of data](/presentations/data-sources/)
- 10:20 am: Break
- 10:30 am: Using StatPREP Little Apps in the Classroom Activity #3: [Confidence intervals](https://statprep-activities.netlify.com/topics/instructions-confidence-intervals/) with Ambika Silva
- 11:15 am: Bootstrapping with the Little App, with Danny and Nick
- 11:45 am: Using StatPREP Little Apps in the Classroom Activity #4: [Two-sample t-test](https://statprep-activities.netlify.com/topics/instructions-two-sample-t-test/) with Danny and Nick
...
- 1:15 pm: Choose one of the following to attend:
    - Workout with a personal trainer: your choice Little Apps/Tutorials/basics of R/...
        - The [OSHA.Rmd](/OSHA.Rmd) file we created during the session.
    - Mosaic R package for teaching stats
- 2:00 pm: Tips for creating an Active Classroom
- 2:30 pm: [It's all about Regression!](/presentations/its-all-regression/) 
- 2:45pm:  Break
- 3:00 pm: Using StatPREP Little Apps in the Classroom Activity #5: [Linear Regression](https://statprep-activities.netlify.com/topics/instructions-linear-regression/) with Danny and Nick
